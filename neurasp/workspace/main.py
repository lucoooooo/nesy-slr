...
parser.add_argument("--method",choices=["exact","sampling"], default = "exact")
...
train_loader_b_ns, test_loader_b_ns, train_set_b_s= utils.mnist_sum_2_loader(
    data_dir, batch_size_train, batch_size_test, "basic",
    train_dataset=train_dataset, test_dataset=test_dataset
)
train_loader_b0_ns, test_loader_b0_ns, train_set_b0_s= utils.mnist_sum_2_loader(
    data_dir, batch_size_train, batch_size_test, "mnistb0",
    train_dataset=train_dataset, test_dataset=test_dataset
)
train_loader_b3_ns, test_loader_b3_ns, train_set_b3_s= utils.mnist_sum_2_loader(
...
for model in rows:
    ...
    compGraph(
            {"nesy": r["train_nesy"]["loss"], "neural": r["train_neural"]["loss"]},
