...
def get_readers(num_train, modelname):
    if modelname == "b0":
        transform = mnistb0_img_transform
    elif modelname == "b3":
        transform = mnistb3_img_transform
    else:
        transform = mnistbasic_img_transform
    ...
    assert num_train * 2 <= 50000 and config.num_valid * 2 <= 10000 and config.num_test * 2 <= 10000
