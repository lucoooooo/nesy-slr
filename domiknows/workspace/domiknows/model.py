...
class MNISTNet_basic_nesy(nn.Module):
    def __init__(self, num_classes=10):
        super(MNISTNet_basic_nesy, self).__init__()
...
class MNISTNet_b0_nesy(nn.Module):
    def __init__(self, N=10):
        super(MNISTNet_b0_nesy, self).__init__()
...
class MNISTNet_b3_nesy(nn.Module):
    def __init__(self, N=10):
        super(MNISTNet_b3_nesy, self).__init__()
...
def build_program(modeltype,sum_setting=None, digit_labels=False, device='cpu', use_fixedL=True, test=False):
    ...
    if modeltype == "b0":
        network = MNISTNet_b0_nesy()
    elif modeltype == "b3":
        network = MNISTNet_b3_nesy()
    else:
        network = MNISTNet_basic_nesy()


    image['logits'] = ModuleLearner('pixels', module=network)
